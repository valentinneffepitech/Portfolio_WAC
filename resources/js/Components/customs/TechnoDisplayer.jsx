...
export const TechnoDisplayer = ({
    ...
    return (
        <div id="technos" className={`flex lg:mx-auto lg:w-[90%]`}>
            <div id="technos__list" className={`w-full overflow-x-hidden flex flex-wrap justify-around lg:justify-center lg:gap-[1rem] flex-shrink-0 transition-all duration-300 border-collapse p-5`}>
                {
