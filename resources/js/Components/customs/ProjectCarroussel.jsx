...
export const ProjectCarroussel = ({
    ...
    return (
        <div className={`fixed top-0 left-0 h-screen w-full bg-[rgba(0,0,0,0.7)] z-20 flex justify-between items-center ${!show ? 'hidden' : 'fadeIn-2'}`}>
            ...
            <img src={projects[screen].image} className='w-[90%] lg:w-[75%] cursor-pointer mb-2 lg:mb-0 aspect-[4/3] lg:aspect-auto border-b-gray-300 border-b-[1px] lg:border-b-0' />
