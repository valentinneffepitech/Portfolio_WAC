...
export const Presentation = () => {
    return (
        <section className='min-h-screen py-[1.5rem]' id="presentation">
            ...
            <div id="accueil__ambiance" className='technoBg py-6 lg:w-4/5 lg:flex md:mx-auto md:w-fit flex-col h-100 justify-center items-center fadeIn-2'>
                <div className='row md:w-[80%] md:flex flex-row-reverse justify-between items-center mx-auto'>
                    <div className='py-3 md:w-1/2 lg:w-1/3'>
                        ...
                        <p className='italic text-center w-4/5 mx-auto appear-down-3 my-3 py-2 glass3 rounded-full'>
                            My code is like my coffee, <br />I prefer it without bugs inside
                        </p>
                    </div>
                    <div className='w-4/5 mx-auto md:mx-0 appear-down-3 my-3 py-2 px-[1rem] glass3 rounded-xl md:w-1/2'>
                        ...
                        <p className='px-3 py-1'>
                            ...
                            <ul className='list-inside mt-2 flex flex-col gap-[.5rem]'>
                                ...
                                <li className='before:content-["\1F6E2"] before:pr-2'>
                                    Sources d'énergie :
                                    <ul className='w-full ml-[15%] flex flex-col gap-2 my-2'>
                                        <li className='before:content-["\2615"] before:pr-2'>
                                            Caféine
                                        </li>
                                        <li className='before:content-["\1F4B8"] before:pr-2'>
                                            Argent
                                        </li>
                                        <li className='before:content-["\1F3C5"] before:pr-2'>
                                            Challenges
                                        </li>
                                    </ul>
                                </li>
                ...
                <div className='w-4/5 mx-auto appear-down-3 my-3 py-2 px-[1rem] glass3 rounded-xl'>
