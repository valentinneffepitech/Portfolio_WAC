    ...
    return (
        <section className='min-h-screen bg-[#252525] py-6 lg:px-[10%] mx-auto' id="formation">
            ...
            <div className='md:items-center'>
                <div className='md:border-t-0 md:border-r-2 md:border-r-white'>
                    <p className='w-3/4 md:w-full mx-auto md:mx-0 md:p-[1rem] text-white pt-4'>
                        Après avoir laissé les lignes de codes de côté pendant plusieurs années, j'ai décidé de reprendre mes études. C'est dans cette démarche que j'ai rejoint la Web@académie par EPITECH à Strasbourg.
                    </p>
                    <p className='w-3/4 md:w-full mx-auto md:mx-0 md:p-[1rem] text-white pt-4'>
            ...
            <div className='md:items-center mt-[1rem]'>
                <div className='border border-transparent pt-4 md:border-r-2 md:border-r-white'>
            ...
            <div className='md:items-center mt-[1rem]'>
                ...
                <div className=' border border-transparent pt-4 md:border-l-2 md:border-l-white'>
                    <p className='w-3/4 md:w-full md:p-[1rem] mx-auto md:mx-0 text-white'>
