    ...
    return (
        <section className='min-h-screen bg-[#000] py-6 lg:px-[10%] mx-auto' id="formation">
            ...
            <div className='md:items-center'>
                <div className='md:border-t-0 md:border-r-2 md:border-r-white lg:pr-16 glass3 py-4 lg:rounded'>
            ...
            <div className='md:items-center mt-[1rem]'>
                <div className='border border-transparent pt-4 md:border-r-2 md:border-r-white lg:pr-16 glass3 py-4 lg:rounded'>
            ...
            <div className='md:items-center mt-[1rem] flex flex-col-reverse'>
                <img src={LogoGrad} className='w-1/2 md:w-3/4 mx-auto my-3' />
                <div className=' border border-transparent pt-4 md:border-l-2 md:border-l-white glass3 py-4 lg:rounded'>
